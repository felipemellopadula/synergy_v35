    ...
    <div className="prose prose-sm max-w-none dark:prose-invert">
      <ReactMarkdown
        components={{
          ...
          h1({ children }) {
            return <h1 className="text-base font-bold mb-4 mt-6 first:mt-0">{children}</h1>;
          },
          h2({ children }) {
            return <h2 className="text-base font-bold mb-4 mt-6 first:mt-0">{children}</h2>;
          },
          h3({ children }) {
            return <h3 className="text-base font-bold mb-3 mt-5 first:mt-0">{children}</h3>;
          },
          ul({ children }) {
            return <ul className="ml-6 mb-4 list-disc space-y-3 marker:text-foreground">{children}</ul>;
          },
          ol({ children }) {
            return <ol className="ml-6 mb-4 list-decimal space-y-3 marker:text-foreground">{children}</ol>;
          },
          li({ children }) {
